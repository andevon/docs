...
Here are answers to some of the questions you might have when using Assistant-Engine
...
<AccordionGroup>
  <Accordion title="How do I reset my API key?">
   ...
   <Accordion title="Is there a limit to the number of projects I can create on the Free Plan?">
   Yes, the Free Plan allows for 1 project. To create more projects, consider upgrading to the Pro or Enterprise Plan.
   </Accordion>
  <Accordion title="Can I upgrade my subscription plan at any time?">
  ...
  <Accordion title="How do I integrate Assistant-Engine with my existing Laravel application?">
  ...
  <Accordion title="What should I do if I encounter an unexpected error?">
