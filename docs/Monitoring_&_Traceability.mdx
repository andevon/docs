...
- **Timings** (only in Pro Plan): Track how long tasks take to execute. See Run steps and Run duration as well as status (`incomplete`, `completed`)
...
- Click `Steps` tab to get detailled information broken down into the steps taken
    ...
    - **Processing Status:** `complete`, ìncomplete``
